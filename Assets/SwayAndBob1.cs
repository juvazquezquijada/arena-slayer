...
public class SwayNBob1 : MonoBehaviour

{
    ...
    public PlayerController1 mover;
    ...
    // Method to reset bobEulerRotation to zero
    public void ResetBobEulerRotation()
    {
    ...
    void BobRotation()
    {
        ...
        {
            // If W, A, S, D keys are not pressed, set the bob multiplier to 0.25
            bobEulerRotation *= 0.75f;
        }
        else
        {
